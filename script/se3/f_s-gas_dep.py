...
plt.plot(p_n2_1, f_n2_1, label="N2 M1", marker='s', linestyle=":", markersize=10)
...
plt.plot(p_n2_1, f_n2_2, label="N2 M2", marker='s', linestyle=":", markersize=10)
...
plt.plot(p_he_1, f_he_1, label="He M1", marker='8', linestyle=":", markersize=10)
...
plt.plot(p_he_2, f_he_2, label="He M2", marker='8', linestyle=":", markersize=10)
